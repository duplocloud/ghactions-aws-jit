...
class DataSource {
    ...
    getTenantAwsJitCredentials(tenantId) {
        return this.api
            .get(`/subscriptions/${tenantId}/GetAwsConsoleTokenUrl`)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AwsJitCredentials = exports.UserTenant = exports.SystemFeatures = exports.CloudPlatform = exports.CustomDataEx = exports.CustomData = void 0;
...
class SystemFeatures {
    constructor(properties) {
        ...
        this.IsComplianceEnabled = false;
        this.IsSiemEnabled = false;
        this.IsBillingEnabled = false;
        this.IsKatkitEnabled = false;
        this.IsAwsCloudEnabled = true;
        this.AwsRegions = [];
        this.IsAzureCloudEnabled = false;
        this.AzureRegions = [];
